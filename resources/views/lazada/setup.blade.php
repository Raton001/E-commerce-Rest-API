                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h4 class="card-title">Sync Lazada Account</h4>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="#" class="wizard-vertical">
                                ...
                                <!-- step 1 content -->
                                <fieldset class="pt-0">
                                    <h6 class="pb-50">Synched account(s) with Lazada</h6>
                                ...
                                <!-- step 2 content -->
                                <fieldset class="pt-0">
                                    <h6 class="py-50">Business Policy</h6>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?php
                                           	if ($policies) {
                ...
                <!-- Nav Tabs End Aligned Ends -->
                                ...
                                <!-- step 4 content -->
                                 <!-- step 2 content -->
                                            ...
                                            <fieldset class="pt-0">
                                    <h6 class="py-50">Axis Shipment</h6>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?php
                                            if ($shipment) {

...
<input type="hidden" id="orderID" value="<?php echo $orderID;?>">
                ...
                <!-- Dashboard Ecommerce Starts -->
                   ...
                   <form method="post" action="/shopee/<?php echo $account;?>/order/request/shipment">
                            @csrf
<section class="">
                    <div class="row">
                        <!-- invoice view page -->
                                ...
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <div class="row mx-0">
                                        <div class="col-xl-4 col-md-12 d-flex align-items-center pl-0">
                                            <h4 class="text-primary">#<?php echo $data['order']['id'];?></h4>
                                                    ...
                                                    <fieldset class="d-flex ">
                                                        ...
                                                        if (isset($data['shipment'][0]->marketplace_id)) {
                                                            ...
                                                            switch ($marketplace) {
                                                                ...
                                                                case '2':
                                                                   ?>
                                                                   <img src="{{ asset('theme/img/shopee.png') }}" alt="logo" height="150" width="250">
                                                                   <?php
                                                                    break;
                                                                case '3':
                                                                   ?>
                                            ...
                                            ?>
                                                <tr>
                                                 ...
                                                 if (isset($value['products'])) {
                                                     ...
                                                     if (isset($value['products'][0])) {
                                                        $pro = $value['products'][0];
                                                     } else {
                                                        $pro = $value['products'];
                                                     }
                                                    foreach ($pro as $k => $v) {
                                                           ...
                                                           if(isset($value['products']->products)) {
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <small class="text-muted"><?php echo $v->variant[1];?></small>
                                                                        ...
                                                                        <td>
                                                                            <span class="badge badge-light-success badge-pill"><?php echo (isset($v->products->quantity) ? $v->products->quantity : '1');?></span>
                                                               ...
                                                               <tr>
                                                                <!-- <table> -->
                                                                    ...
                                                                    <small class="text-muted"><?php echo $v->variant[1];?></small>
                                                                       ...
                                                                       <td>
                                                                            <span class="badge badge-light-success badge-pill"><?php echo (isset($v->package->quantity) ? $v->package->quantity : '1');?></span>

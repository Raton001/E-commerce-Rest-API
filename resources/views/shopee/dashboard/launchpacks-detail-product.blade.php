...
if ($url != '') {
                ...
                ?>
               <div class="swiper-slide"> <img class="img-fluid" src="http://ebx.axisdigitalleap.asia/web/uploads/product/<?php echo $url;?>" alt="{{ $url }}" style="width:300px; height:300px;"></div> 
              ...
              <?php }
                ...
                <div class="swiper-slide"> <img class="img-fluid" src="http://ebx.axisdigitalleap.asia/web/uploads/product/<?php echo $product->photo;?>" alt="{{ $product->photo }}" style="width:300px; height:300px;"></div>
                <?php
                 }?>

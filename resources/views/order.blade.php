...
<?php 
    ...
    foreach($order as $key => $value){
        $custDetails = $value['OrderArray']['Order']['ShippingAddress'];
        $custId = $value['OrderArray']['Order']['BuyerUserID'];
        $salesDetails = $value['OrderArray']['Order'];
        $totalTax = $value['OrderArray']['Order']['TransactionArray']['Transaction']['Taxes']['TotalTaxAmount'];
        $shippingDetails = $value['OrderArray']['Order']['TransactionArray']['Transaction']['ShippingDetails']['ShipmentTrackingDetails'];
        $hand_ship = $value['OrderArray']['Order']['TransactionArray']['Transaction']['Taxes']['TaxDetails'];
    }
                      ...
                      <div class="card-body">
                          ...
                          <table id="users-list-datatable" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $totalAllAmount = 0.0;
                                            foreach($order as $key => $value){
                                                $order1 = $value['OrderArray']['Order']['TransactionArray'];
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format((double)$transaction['TransactionPrice'], 2, '.', '') }}</td>
                                                <td>{{ number_format((double)$transaction['Taxes']['TotalTaxAmount'], 2, '.', '') }}</td>
                                                <td>{{ number_format((double)$totalAmount, 2, '.', '') }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="5"></td>
                                                <td>Total Taxes : USD {{ number_format((double)$totalTaxes, 2, '.', '') }}</td>
                                                <td>Total Taxes : USD {{ number_format((double)$totalAllAmount, 2, '.', '') }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                          </div>

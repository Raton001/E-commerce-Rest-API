...
<?php
    ...
    ?>
 <form method="post" action="/<?php echo $marketplace;?>/<?php echo $account;?>/<?php echo $form;?>">
...
<input type="hidden" name="marketplace" id="marketplace" value="<?php echo $marketplace;?>">

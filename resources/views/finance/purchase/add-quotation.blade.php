      ...
      <div class="row mt-5 mx-1" >
          <div class="col-4 col-sm-4 py-2 wow fadeInRight" data-wow-delay="300ms">
            ...
            <div class="col-4 col-sm-4 py-2 wow fadeInLeft" data-wow-delay="300ms">
              ...
              <input type="date" name="valid_dt" id="valid_dt" class="form-control" value="{{ date("Y-m-d") }}" required>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="false">
                    <input type="hidden" class="form-control" id="item_doc_id">

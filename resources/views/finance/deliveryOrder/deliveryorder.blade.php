...
<div class="my-3 mr-1">
   <a href="{{route('add.delivery.order')}}">
      <button class="btn btn-primary float-right"> Add Delivery Order </button>
   </a>
...
<div class="d-flex justify-content-between">
  ...
  @foreach ( $companies  as $company )
   <?php
        $count = DB::table('delivery_order')
                ->where('company_id','=', $company->id)
                ->where('deleted_status', '=', 0)->count();
   ?>

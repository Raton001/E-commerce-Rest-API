    ...
    <td width="50%" valign="top" style="">
        <br/><b> BILL TO</b>
            <table cellpadding="0" cellspacing="0">
                ...
                <tr><td colspan="3" align="center"><h4><b>CREDIT NOTE</b></h4><br/><br/></td></tr>
                </table>
                <table cellpadding="0" cellspacing="0" style="padding-right:1em;">
                <tr>
                ...
                <tr>
                <td valign="top">Credit Note No</td>
                <td valign="top">&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                <td valign="top" align="left">{{$invoicedata->doc_no}}</td>
                </tr>

            @if (!empty($invoicedata->ref))
                <tr>
            ...
            @if(!empty($invoicedata->term))
                ...
                <td valign="top">&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                <td valign="top" align="left">{{$daysparam->ref}}</td>
                </tr>
                </table>
                </td>
                </tr>
          ...
          <div style="font-size:20px;line-height:1.7em;">{!! $invoicedata->notes !!}</div>
           @endif

 ...
 @if(!empty($companies))
   ...
   <?php
        $count = DB::table('invoice')
                    ...
                    ->where('type', '=', 'reseller')->count();
   ?>
   <div class="card ml-2 mx-2" style="width: 18rem; height: 8rem">
    <div class="card-body d-flex justify-content-between" >
        <div class="pr-1"><img src="assets/images/company_logo/{{$company->logo}}" alt="" height="30" width="30"></div>

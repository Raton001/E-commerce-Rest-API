...
// add secondary btn class
$('.actions a[role="menuitem"]').addClass("btn btn-secondary");
$('.icon-tab [role="menuitem"]').addClass("glow ");
$('.wizard-vertical [role="menuitem"]').removeClass("btn-secondary").addClass("btn-light-secondary");
